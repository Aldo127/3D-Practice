...
public class LedgeGrabbing : MonoBehaviour
{
    ...
    public float ledgeDetectionLegth;
    ...
    void LedgeDetection()
    {
        bool LedgeDetected = Physics.SphereCast(transform.position, ledgeSphereCastRadius, cam.forward, out ledgeHit, ledgeDetectionLegth, whatIsLedge);
